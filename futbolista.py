...
class Futbolista(Persona,Deportista):
    ...
    def __str__(self):
        salida = "Mi nombre es {} soy profesional en el deporte {} Tengo {} años de edad y llevo {} años en el deporte".format(self.getNombre,self.getDeporte,self.getEdad,self.getAñosPracticando)
